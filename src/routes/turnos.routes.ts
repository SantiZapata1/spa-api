...
import { solicitarTurno, eliminarTurno, obtenerTurnos, obtenerTurnoPorFechas } from '../controllers/turnos.controllers'
...
router.get('/obtener-turno-por-fechas/:desde/:hasta', obtenerTurnoPorFechas)
